...
Crear y activar el entorno virtual en Windows (PowerShell):

PowerShell
python -m venv .venv --without-pip
.venv\Scripts\Activate.ps1
python -m ensurepip --default-pip
Instalar las dependencias del proyecto (limpiando caché para compatibilidad):

Bash
pip install -r requirements.txt --no-cache-dir
Configurar el archivo de entorno de seguridad:

Duplica o renombra el archivo .env.example con el nombre .env.

Agrega los accesos correspondientes a tu API de Ollama Cloud.

⚠️ Nota: El archivo .env se encuentra protegido en el .gitignore para salvaguardar tus credenciales.
...
Bash
   git clone [https://github.com/tu-usuario/simulador_clientes_ai.git](https://github.com/tu-usuario/simulador_clientes_ai.git)
...
Aquí tienes todo el contenido estructurado en un formato Markdown limpio, profesional y optimizado para tu archivo de documentación, listo para copiar y pegar directamente en Visual Studio Code:

```markdown
# ⚙️ Guía de Instalación y Casos de Uso — Simulador de Clientes AI

## 📋 Instrucciones de Instalación y Ejecución

### Prerrequisitos
* **Sistema Operativo:** Windows 10/11.
* **Python:** Versión `3.13` o superior instalada.
